...
public class ModItems
{
    ...
    public static final SpearItem WoodSpear = new SpearItem(ItemTier.WOOD, 2, -3, 5, (new Item.Properties().tab(ItemGroup.TAB_COMBAT)), "wood");
    public static final SpearItem StoneSpear = new SpearItem(ItemTier.STONE, 2, -3, 5, (new Item.Properties().tab(ItemGroup.TAB_COMBAT)), "stone");
    public static final SpearItem IronSpear = new SpearItem(ItemTier.IRON, 2, -3, 5,  (new Item.Properties().tab(ItemGroup.TAB_COMBAT)), "iron");
    public static final SpearItem GoldSpear = new SpearItem(ItemTier.GOLD, 2, -3, 5, (new Item.Properties().tab(ItemGroup.TAB_COMBAT)), "gold");
    public static final SpearItem DiamondSpear = new SpearItem(ItemTier.DIAMOND, 2, -3, 5, (new Item.Properties().tab(ItemGroup.TAB_COMBAT)), "diamond");
    public static final SpearItem NetheriteSpear = new SpearItem(ItemTier.NETHERITE, 2, -3, 5, (new Item.Properties().tab(ItemGroup.TAB_COMBAT)), "netherite");
