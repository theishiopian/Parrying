...
public class ModPotions
{
    ...
    public static final RegistryObject<Potion> IMMORTALITY = POTIONS.register("immortality", () -> new Potion(new MobEffectInstance(ModEffects.IMMORTALITY.get(), 200)));
    public static final RegistryObject<Potion> IMMORTALITY_LONG = POTIONS.register("immortality_long", () -> new Potion(new MobEffectInstance(ModEffects.IMMORTALITY.get(), 400)));
}
